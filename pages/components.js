...
// sample data
const selectOptions = [
    <option disabled value="" key="drop-down-option-default">
        {"Drop Down label"}
    </option>,
    ...new Array(4).fill("").map((otion, index) => (
        <option key={`drop-down-option-${index}`} value={`option-${index + 1}`}>
...
const onSelectChange = (e) =>
    console.log("Select > change, value:", e.target.value);
const onImageCarouselChange = (index) =>
    console.log("ImageCarousel > change, index:", index);
